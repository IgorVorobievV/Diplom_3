...
def test_click_ingredient_open_detail_modal(driver):
...
def test_click_close_button_close_detail_modal(driver):
...
def test_add_ingredient_incremented_counter(driver):
